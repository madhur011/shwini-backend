...
exports.getDashboard = async (req, res) => {
  try {
    const [totalUser, allProduct, totalProduct, totalPayment, allOrder, pandingOrder, confirmOrder, deliverdOrder, CencalOrder, returnOrder] = await Promise.all([
      User.countDocuments(),
    ...
    const dashboard = {
      ...
      totalEarn: totalPayment[0].amount,
      order: {
        allOrder,
        pandingOrder,
        confirmOrder,

const { User, Product, Payment, Order, Setting } = require("../model/index.model");
...
exports.updateSetting = async (req, res) => {
  try {
    ...
    const { headerOffer, webText, footerText, companyName, contact, email, address, shopTime, deliveryDay, returnDay, razorKey, razorApiSecret } = req.body
